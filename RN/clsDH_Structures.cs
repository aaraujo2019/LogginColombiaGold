...
public class clsDH_Structures
{
    ...
    public string DH_Structures_Add()
    {
        ...
        {
            object oRes;
            SqlParameter[] arr = oData.GetParameters(18);
            arr[0].ParameterName = "@Opcion";
            arr[0].Value = sOpcion;
            arr[1].ParameterName = "@HoleID";
            arr[1].Value = sHoleID;
            ...
            arr[17].ParameterName = "@LowerAngleAxis";
            if (LowerAngleAxis == null)
            {
                arr[17].Value = SqlDouble.Null;
            }
            else
            {
                arr[17].Value = LowerAngleAxis;
            }
